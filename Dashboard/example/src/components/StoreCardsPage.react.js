            ...
            <Grid.Col width={12} sm={12} lg={12}>
              <div className="card card-stats">
                <div className="content">
                  <Grid.Row>
                    <Grid.Col >
                      <div class="card-body p-3 text-center">Die komplette Historie speichert Google für Sie in der Cloud. Damit weiß Google welche Seiten Sie wann wie oft aufrufen und welche Lesezeichen Sie gesetzt haben. Hier sehen Sie zudem, wie viel Prozent der Webseiten eine SSL-Verschlüsselung benutzen. </div>
                    </Grid.Col>
                  </Grid.Row>
                </div>
              </div>
